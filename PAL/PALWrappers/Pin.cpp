...
void Pin::set(bool high){ igpio->set(high); }
bool Pin::read(){ return igpio->read(); }
void Pin::reconfig(const PinCfg& newCfg){ cfg_ = newCfg; init(); }
PinCfg Pin::cfg() const{ return cfg_; }
